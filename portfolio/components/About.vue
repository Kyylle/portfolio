  ...
  <section class="about-section pt-24">
    <div class="container mx-auto px-4">
      ...
      <div class="text-center mb-8">
        <h1 class="text-4xl font-bold text-[#00FD37]">About Me</h1>
      ...
      <div class="flex flex-col md:flex-row items-center">
        ...
        <div class="md:w-2/3 md:pl-12">
          ...
          <h1
            class="text-[#00FD37] text-5xl md:text-6xl font-bold leading-relaxed"
          >
            Sung Jin Woo
          </h1>
          <p class="text-white text-regular leading-relaxed mt-4">
            I started as the weakest E-rank hunter, barely surviving in dungeons
            while others looked down on me. But everything changed when I
            entered a mysterious double dungeon. After a near-death experience,
            I awakened a unique ability called the "System," allowing me to
          ...
          <div class="mt-6 flex justify-center md:justify-start">
            ...
            >
              <span class="text-xl">❮ ❯</span> View Projects
            </button>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
        ...
        >
          <div class="flex flex-row items-center justify-between w-full">
            <div
              class="bg-gray-800 p-3 rounded-full flex items-center justify-center w-16 h-16"
            >
              <img
                src="/public/images/icon_projects.png"
                alt="Projects"
                class="w-8 h-8"
              />
            </div>
            <span class="text-white text-4xl font-bold">0</span>
          </div>
          <h2 class="text-white text-lg font-semibold mt-4">TOTAL PROJECTS</h2>
        ...
        >
          <div class="flex flex-row items-center justify-between w-full">
            ...
            >
              <img
                src="/public/images/icon_cert.png"
                alt="Certificates"
                class="w-8 h-8"
              />
            </div>
          ...
          <h2 class="text-white text-lg font-semibold mt-4">CERTIFICATES</h2>
        ...
        >
          <div class="flex flex-row items-center justify-between w-full">
            ...
            >
              <img
                src="/public/images/icon_experience.png"
                alt="Experience"
                class="w-8 h-8"
              />
            </div>
